	...
	public class Jeopardy implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(buttonPressed == firstButton) {
				...
				askQuestion("What type of candy are tiny, round, assorted colors, and are chewy?" , "Skittles" , 100);
			}
				// Call the askQuestion() method
				if(buttonPressed==secondButton) {
					
					askQuestion("What are Californians favorite Halloween candy?" , "Lifesavers" , 200);
				}
	...
	if(ans.equals(correctAnswer)) {
		score += prizeMoney;
			...
			// Otherwise
				...
				// Call the updateScore() method
				JOptionPane.showMessageDialog(null, "You have"+ prizeMoney+"!");
